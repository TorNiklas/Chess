...
b_check		  = "RNBQKBNRPPPPPPPP............................................k.Q."
w_check		  = ".q..K...........................................pppppppprnbqkbnr"
	...
	if(color == "black"):
		for y in board:
			for x in y:
				if (get_piece(x, y) == "k"):
					return x, y
def checkCheck(color, x=None, y=None):
	if(color=="white"):
		for yy in range(len(board)):
			for xx in range(len(board[0])):
				if (get_piece(xx, yy) in black_pieces):
					print("I")
					if(x==None and y==None):
						if(getKing("white") in get_legal_moves(xx, yy)):
							return True
					elif(x!=None and y!=None):
						if([x, y] in get_legal_moves(xx, yy)):
							return True
		return False
	...
	if(color=="black"):
		for yy in board:
			for xx in yy:
				if (get_piece(xx, yy) in white_pieces):
					if(x==None and y==None):
						if(getKing("black") in get_legal_moves(xx, yy)):
							return True
					elif(x!=None and y!=None):
						if([x, y] in get_legal_moves(xx, yy)):
							return True
